"""
Step 2: TF-IDF Class with Reuse and Extension
"""
...
if __name__ == "__main__":
    ...
    print("Top words in doc 0:", tfidf.find_most_important_words(0))
    print("Common words doc 0 & 2:", tfidf.compare_documents(0, 2))
